...
int main(){
    ...
    //  Wait for all previous operations before using values, We need this because we don't get the 
    // implicit synchronization of cudaMemcpy like int he orignal example
